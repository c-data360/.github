...
**Build. Scale. Empower Africa.**

Écosystème numérique panafricain offrant des solutions complètes en transformation digitale, intelligence artificielle, formation professionnelle et recherche appliquée.
...
| Outil                    | Usage                                     |
| ------------------------ | ----------------------------------------- |
| Next.js · TypeScript     | Applications web et sites institutionnels |
| Turborepo · pnpm         | Monorepos multi-apps                      |
| Tailwind CSS · Shadcn/UI | Design system et interfaces               |
| Vercel                   | Déploiement et hosting web                |
| Supabase                 | Base de données, Auth, Storage (Postgres) |
| Prisma                   | ORM                                       |
| Auth.js · Payload CMS    | Authentification et gestion de contenu    |
...
| React Native / Expo | Applications multiplateformes (migration à moyen terme) |
| Python / FastAPI    | Backend mobile                                          |
| Spring Boot         | Backend mobile alternatif                               |

### Qualité & Observabilité

| Outil                       | Usage                                     |
| --------------------------- | ----------------------------------------- |
| Biome                       | Lint et formatage (monorepos)             |
| ESLint                      | Lint et formatage (projets monolithiques) |
| Sentry                      | Error tracking et performance             |
| PostHog                     | Analytics produit et funnels              |
| GitHub Actions · Changesets | CI/CD et versioning automatisé            |
